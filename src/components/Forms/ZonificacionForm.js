...
export const ZonificacionForm = () => {

    const URI = `${process.env.REACT_APP_API_URL}api/zonificacion/new`
    const URIUS = `${process.env.REACT_APP_API_URL}api/usoSuelo/`
    ...
    const getTramiteById = async () => {
        const res = await axios.get(URIUS + id)
            ...
            <Formik
                ...
                onSubmit={async (values) => {
                    ...
                    await axios.post(URI, {
                        ...
                        area,
                        ...values,
                        idUnidad: usoSuelo.idUnidad,
                        nombreSolicitante: usoSuelo.nombreSolicitante,
                        nombrePropietario: usoSuelo.nombrePropetario,
                        cedula: usoSuelo.cedula,
                        distrito: usoSuelo.distrito,
                        planoCatastro: usoSuelo.planoCatastro,
                        tipoUsoSuelo: usoSuelo.tipoUsoSuelo,
                        propiedadMatricula: usoSuelo.propiedadMatricula,
                        direccion: usoSuelo.direccion,
                    })
