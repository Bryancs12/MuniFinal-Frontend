        ...
        <>
            <View style={styles.breakable}>
                <Text style={{ top: 5, width: 440, fontSize: 12 }}>Artículo 10.
                    <Text style={{ fontFamily: 'Arial CE BOLD', fontWeight: 'ultrabold', fontSize: 12, }}> Zona Residencial Media (ZRM):</Text>
                </Text>
            </View>
            ...
            <View style={styles.breakable}>
                ...
                <Text style={{ fontFamily: 'Arial', fontSize: 12, }}>ZRM                 250 M2                           7,50 M                  100Hab/Ha.   </Text>
                <Text style={{ fontFamily: 'Arial', fontSize: 12, }}>ZRB                  450 M2                          10,00 M                 88Hab/Ha.   </Text>
            </View>
            ...
            <View style={styles.breakable}>
                <Text style={{ fontFamily: 'Arial', fontSize: 12, left: 27}}>Frontal:         2,50 metros.</Text>
                <Text style={{ fontFamily: 'Arial', fontSize: 12, left: 27, }}>Lateral:         no se exige.</Text>
                <Text style={{ fontFamily: 'Arial', fontSize: 12, left: 27, }}>Posterior:      3 metros.
                </Text>
            </View>
