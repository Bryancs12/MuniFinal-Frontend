        ...
        <>
            <View style={styles.breakable}>
                <Text style={{ width: 440, fontSize: 12 }}>Artículo 10.
                    <Text style={{ fontFamily: 'Arial CE BOLD', fontWeight: 'ultrabold', fontSize: 12, }}> Zona Residencial Baja (ZRB):</Text>
                </Text>
            </View>
            ...
            <View style={styles.breakable}>
                ...
                <Text style={{ fontFamily: 'Arial', fontSize: 12, left: 27, top: 7 }}>Posterior:      3 metros.
                </Text>
            </View>
