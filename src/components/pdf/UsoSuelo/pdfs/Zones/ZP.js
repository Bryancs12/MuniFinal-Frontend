...
export const ZP = () => {
  return (
    <>
      ...
      <View style={styles.breakable}>
        <Text style={{ fontFamily: 'Arial', fontSize: 12, textAlign: 'justify' }}>
          <Text style={{ fontFamily: 'Arial CE BOLD', fontSize: 12, }}>23.4 </Text>
          Prohibiciones- Queda absolutamente prohibidas en dicha zona toda actividad que no sea la descrita antes.
        </Text>
      </View>
    </>
  )
