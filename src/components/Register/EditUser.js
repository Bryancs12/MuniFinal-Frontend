...
export const EditCumScreen = () => {
    ...
    const initialValues = {
        ...
        nombreUsuario: editUser?.nombreUsuario,
        gradoUsuario: editUser?.gradoUsuario,
        // roleId: editUser?.account_roles[0]['role_id'],
        tipoUnidad: editUser?.tipoUnidad,
    }
    ...
    const handleUserRole = (values) => {
        return (
            ...
            >
                    ...
                    <option value="3">Usuario - Uso suelo</option>
                    <option value="5">Usuario - Visto bueno</option>
                    <option value="4">Usuario - Zonificacion Uso suelo</option>
                    <option value="8">Usuario - Zonificacion Visto bueno</option>
  ...
  return (
    <> 
        ...
        onSubmit={async (values, {resetForm}) =>{
            ...
            // resetForm();    
            await axios.put(URI+'edit/' + id, values) 
            navigate('/users');
      ...
      <Form className='flex justify-center grid italic bg-gray-200 pt-16'>
                        ...
                        <div class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 flex flex-col">
                            ...
                            <div className='text-3xl mb-6 text-center'>Editar usuario</div>
                            ...
                            <div class="md:w-1/2 px-3">
                                    ...
                                    <Field class="placeholder-gray-400 placeholder-opacity-50 block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" type="text"
                                        ...
                                        <option value="Gestion de Ingenieria">Gestion de Ingenieria</option>
                                    </Field>
